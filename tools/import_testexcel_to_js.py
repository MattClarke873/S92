...
def convert_excel_to_js(input_file, output_file):
    ...
    js_data = []
    last_category = None  # To track the previous category
    last_aircraft = None  # To track the previous aircraft
    ...
    for obj in js_data:
        ...
        current_aircraft = obj["Aircraft"]

        # Check if category or aircraft has changed
        if last_aircraft != current_aircraft or last_category != current_category:
            js_data_str += f'/*TODO  {current_aircraft} -- ATA {current_category}*/\n'
